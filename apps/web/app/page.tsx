  ...
  return (
    <>
      ...
      <div className="wrap">
        ...
        {/* AI explanation */}
        <section className="card">
          <h2>Explanation — AI Analyst</h2>
          <p className="sub">
            {m.ai.source === "claude"
              ? `Generated by Claude (${m.ai.model}) from validated figures.`
              : "Deterministic fallback (no ANTHROPIC_API_KEY configured). Set the key to use the live model."}
            {" "}The model may explain; it cannot compute the amount, approve, or execute.
          </p>
          ...
          <p className="disclaimer" style={{ marginTop: 12, borderTop: "none", paddingTop: 0 }}>{m.ai.disclaimer}</p>
        </section>
