...
concurrency-safe workflow (one approval per proposal) plus a separate deterministic verifier; the proposal
...
AI prepared the analysis, deterministic policy and a separate deterministic verifier gated it, a human
